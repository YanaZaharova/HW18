...
public class AppCardDeliveryTest {
    ...
    @Test
    void sendingSuccessfulApplication() {
        WebElement form = driver.findElement(By.cssSelector("form"));
        form.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Захарова Яна");
        form.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+79991112200");
